...
import { listLaws, fetchLawDetail } from "../src/collectors/providers/lawgo_law";
import { normalizeLaw } from "../src/collectors/normalize/lawgo_normalize";
...
async function main(): Promise<void> {
  ...
  log.log(
    `[collect:law] start pages=${argv.pages} perPage=${argv.perPage} concurrency=${argv.concurrency}`
  );
